...
{ id: "slabs", title: "Slabs", desc: "Concrete slabs." },
{ id: "garage-floor", title: "Garage Floor", desc: "Garage floor solutions." },
{ id: "pads", title: "Pads", desc: "Concrete pads." },
{ id: "basements", title: "Basements", desc: "Basement concrete work." },
{ id: "exposed-concrete", title: "Exposed Concrete", desc: "Decorative exposed concrete." },
{ id: "commercials", title: "Commercials", desc: "Commercial concrete areas." },
{ id: "parking", title: "Parking", desc: "Parking lots and pads." },
{ id: "replacement", title: "Replacement", desc: "Concrete replacement." },
{ id: "epoxy", title: "Epoxy", desc: "Epoxy coatings." },
...
Trusted Concrete Contractor in Edmonton
</h2>

<p>
All Seven Concrete Ltd is your trusted partner for exterior concrete work
in Edmonton and surrounding areas. We specialize in residential and
commercial concrete services, including driveways, patios, sidewalks,
slabs, garage floors, and warehouse flooring.
</p>

<p>
Our team focuses on replacing and upgrading the exterior concrete of homes
and businesses using high-quality materials and proven workmanship. Every
project we undertake is completed with attention to detail and a commitment
to attractive, durable results.
</p>

<p>
Driveways • Patios • Sidewalks • Slabs • Garage Floor • Pads • Detached Garages •
Basements • Exposed Concrete • Commercials • Parking • Replacement • Epoxy • Repair
— clean finish, solid reinforcement, and dependable timelines.
</p>
</div>
...
Tell us what you need — we’ll reply quickly.
</p>
...
<p className="text-sm text-gray-600 mt-1">
Click a service to auto-select it in the form.
</p>
